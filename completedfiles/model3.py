...
cons_df = pd.read_csv(path + "\\construction.csv")
...
cons_neighbour = cons_df.groupby("neighbourhood_id").agg(
    {
...
neighbour_data = (
    temp_neighbour.join(surface_neighbour, how="inner")
    .join(air_neighbour, how="inner")
    .join(cons_neighbour, how="inner")
)
